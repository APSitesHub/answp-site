...
const MyANSWP = lazy(() =>
  import(/* webpackChunkName: "My ANSWP Page" */ '../pages/MyANSWP/MyANSWP')
);
  ...
  return (
    <>
      ...
      <Suspense fallback={Loader} noindex={true}>
        <Routes noindex={true}>
          <Route index path="/" element={<MyANSWP />} noindex={true}></Route>
          <Route
            path="admin"
            element={<UniUserAdminPanel uni={'ANSWP'} lang={'pl'} />}
            noindex={true}
          />
