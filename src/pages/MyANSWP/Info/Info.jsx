...
import { InfoBtnIcon } from '../MyANSWPPanel/MyANSWPPanel.styled';
import {
  InfoBox,
  InfoHeading,
  InfoList,
    ...
    <InfoBox style={{ top: '142px' }}>
      ...
      <InfoList>
        <InfoListItem>
          ...
          <PdfBox>
            <PdfWrapper>
              <PdfLink
                ...
                href="https://answp.ap.education/static/docs/Internship_journal.pdf"
              >
                <PdfIcon />
                Internship Journal
              </PdfLink>
          ...
          <Video
            src="https://answp.ap.education/static/docs/instructions_for_the_internship_journal.mp4"
            type="video/mp4"
            width={'100%'}
            controls
            autoPlay={true}
